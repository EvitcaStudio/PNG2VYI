...
function makeVyi()
	...
	var wasFrame
	var previousDraw
	var tiles = Math.round((img.width / width) * (img.height / height)) + 20000//find a more solid fix then this, the last few tiles of some images are cut off without this
	var x = 0
	var y = 0
